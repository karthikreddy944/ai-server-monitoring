...
Recommendation:
Check high CPU-consuming processes and consider closing
...
AI Explanation:
Memory utilization is increasing and may approach the
configured threshold if the current trend continues.
...
Used to generate AI explanations for monitored metrics.

Risk
/api/risk

Provides risk information for monitored resources.
...
Provides resource trend information.
